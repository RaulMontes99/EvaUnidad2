...
class Pregunta3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_pregunta_three, container, false)
        perform(view)
        return view
    }

    fun perform(view: View) {
        val rdbR1P2: RadioButton = view.findViewById(R.id.radioButton)
        val rdbR2P2: RadioButton = view.findViewById(R.id.radioButton2)
        val rdbR3P2: RadioButton = view.findViewById(R.id.radioButton3)
        val rdbR4P2: RadioButton = view.findViewById(R.id.radioButton5)
